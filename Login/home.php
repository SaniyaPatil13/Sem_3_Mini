...
<body>
  ...
  <div class="pat">
    ...
    <figure class="figure">
      <img src="download.png" class="figure-img img-fluid rounded" alt="Somaiya Trust" style="height: 90px; width: 110px;margin-left: 750px;">
      <figcaption class="figure-caption"></figcaption>
    </figure>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="signup.php" style="font-size: 25px; color: #ffffff;">Sign up</a>
          </li>
          <li class="nav-item">
...
<div class="buton">
  ...
  style="background-color: rgb(156, 1, 1);color: rgb(247, 246, 246) ; --bs-btn-font-size:18px; border: 3px solid rgb(11, 1, 1);"><a href="login.php" style="color:#ffffff";>Login</a>

</button>    
<button type="button"  class="btn btn-primary"
  style="background-color: rgb(171, 1, 1);color: rgb(240, 255, 255) ; --bs-btn-font-size:18px; border: 3px solid rgb(7, 0, 0);"><a href="register.php" style="color:#ffffff";>Signup</a>
