...
<body>
  ...
  <div class="pat">
    <figure class="figure">
      <img src="Somaiya Full Logo.png" class="figure-img img-fluid rounded" alt="KJSIT" style="height: 100px; width: 800px;">
      <figcaption class="figure-caption"></figcaption>
    </figure>
    <figure class="figure">
      <img src="download.png" class="figure-img img-fluid rounded" alt="Somaiya Trust" style="height: 80px; margin-left: 500px;">
      <figcaption class="figure-caption"></figcaption>
    </figure>
            </div>
    ...
    <div class="cont"style= "border-radius=6px;">
      <a href="new.php" style="color:rgb(163, 5, 5) ;">
        <p> Sum rule</p></a>
        </div>
    <div class="cont"style= "border-radius=6px;">
      <a href="product.php" style="color:rgb(163, 5, 5) ;">
        <p> Product rule</p></a>
        </div>
    <div class="cont"style= "border-radius=6px;">
      <a href="inclusion.php" style="color:rgb(163, 5, 5) ;">
       
        <p>Inclusion &  Exclusion Principle</p> </a>
        </div> 
    <div class="cont"style= "border-radius=6px;">
      <a href="pigeonaim.php" style="color:rgb(163, 5, 5) ;">
