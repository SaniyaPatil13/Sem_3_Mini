...
<body>
  ...
  <nav class="navbar navbar-expand-lg " style="background-color: rgb(154, 4, 4); height: 15vh;margin-left: 20px;margin-right: 20px;">
    <div class="container-fluid">
        ...
        <a class="nav-link active" aria-current="page"  href="#" style="color: black;">KJSIT</a>
...
<div class="buton">
  ...
  style="background-color: rgb(156, 1, 1);color: rgb(247, 246, 246) ; --bs-btn-font-size:18px; border: 3px solid rgb(11, 1, 1);"><a href="login.html" style="color:#ffffff";>Login</a>

</button>    
<button type="button"  class="btn btn-primary"
  style="background-color: rgb(171, 1, 1);color: rgb(240, 255, 255) ; --bs-btn-font-size:18px; border: 3px solid rgb(7, 0, 0);"><a href="signup.html" style="color:#ffffff";>Signup</a>
