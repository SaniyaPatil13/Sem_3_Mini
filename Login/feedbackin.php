...
.pic{text-align:left; width:33%; float:left;display: flex;justify-content:center;flex-align:center;}
</style>
<body>
 <div class="form_box shadow">
 <form method="post" action="inclusion_ac.php">
 <div class="heading">
   Feedback Form for Inclusion & Exclusion Principle
 </div>
 <br/>
 <p>What is your overall impression about the Inclusion & Exclusion Principle</p>
 <div>
   <div class="pic">
