...
<body>
  <Body background="https://img.freepik.com/premium-photo/abstract-white-background-product-display-with-banner-background_655634-81.jpg" style="background-size: cover;">
    <div class="pat">
      ...
      <figure class="figure">
        <img src="download.png" class="figure-img img-fluid rounded" alt="Somaiya Trust" style="height: 90px; width: 110px;margin-left: 1300px;margin-top: -150px;">
        <figcaption class="figure-caption"></figcaption>
      </figure>
...
<form id="n(AUB)">
  ...
  style="background-color: rgb(171, 1, 1);color: rgb(240, 255, 255) ; --bs-btn-font-size:18px; border: 3px solid rgb(7, 0, 0); margin-left: 650px;"><a href="ven.html" style="color:#ffffff";>Generate a venn diagram</a>
