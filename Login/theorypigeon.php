...
<div class="sidenav">
	...
	<a href="Pigeon Hole.jar">Simulator</a>
...
<h2>Theory</h2>
<p>
    The Pigeonhole Principle, central in combinatorics, states that if n objects are placed into m containers, and n > m, at least one container will contain more than one object. This principle can be expressed by the formula:
...
[n/m
 ...
 containers must contain more than one object.
If n>m, then  
[ 
m
n
...
Where n represents the number of objects, m represents the number of containers, and 
[
n/m
]
[ 
...
n
​
 ] denotes the ceiling function, which rounds up the result of the division to the nearest integer. The Pigeonhole Principle is a fundamental tool for proving the existence of solutions, establishing lower bounds, and analyzing various mathematical and practical problems.
